...
Motivação
Dados brutos raramente são confiáveis. Erros de input manual, falhas de sensores ou inconsistências de sistema podem inserir "ruído" nas análises. Este projeto implementa uma camada de validação automatizada que foca em três pilares: **Preenchimento, Consistência Lógica e Estabilidade Estatística.**
...
Instale as dependências necessárias:
    ...
    ```
Execute o script para visualizar o relatório de auditoria:
    ```bash
    python main.py
    ```
